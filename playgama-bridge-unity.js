...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/VK The Word Finder.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/VK The Word Finder.data.unityweb',
                        frameworkUrl: 'Build/VK The Word Finder.framework.js.unityweb',
                        codeUrl: 'Build/VK The Word Finder.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'words the word',
                        productVersion: '1.0',
